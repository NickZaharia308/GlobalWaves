...
* **commands/**
   ...
   * **page/**
     ...
     * **PrintCurrentPage** - Displays the page that the user selected
     * **Subject** - Subject Class in Observer design pattern that has as subjects artists and hosts
     * **Observer** - Interface implemented by normal users that are on an artist or host page
 ...
 * #### Miscellaneous
   * **Comparator**: PageMenu, GetTop5Artists, GetTop5Albums, GetTop5Songs, GetTop5Playlists
   * **Iterator**: DeleteUser, RemoveAlbum
   * **Stream**: DeleteUser, Songs
   * **Lambda Expressions**: AddAlbum, DeleteUser, Subject
